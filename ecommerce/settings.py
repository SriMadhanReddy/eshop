...
EMAIL_HOST_USER = 'madhanreddy.1995@gmail.com' # - Enter your GMAIL address # The host email that sends password reset emails
EMAIL_HOST_PASSWORD = 'gjmsaqiwyddkihfm' # - Enter your app password 
